      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className="bg-white p-8 rounded-2xl border-2 border-gray-100 shadow-sm hover:shadow-xl hover:shadow-purple-200 transition-all duration-300 hover:-translate-y-2 hover:border-purple-200 cursor-default"
            >
