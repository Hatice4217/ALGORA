...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50">
      ...
      {/* Neden ALGORA? Section - Lazy loaded for better initial render */}
      <Suspense fallback={<div className="container mx-auto px-6 py-20 text-center">Yükleniyor...</div>}>
        <WhyAlgoraSection />
      </Suspense>
